...
def convert():
    ...
    for key, val in state_dict.items():
        ...
        if "masked_spec_embed" in new_key: continue
        
        # 3. Skip weight_norm parametrizations
        if "pos_conv_embed" in new_key and (".weight" in new_key or "parametrizations" in new_key or "weight_" in new_key):
    ...
    save_path = os.path.join(os.getcwd(), "rvc", "models", "embedders", "contentvec", "hubert_mlx.npz")
